...
/////////////////////////////////////////////////////////////////////////////
// CXTOleIPFrameWnd extends the standard COleIPFrameWnd class to allow CXTDockWindow
// and CXTToolBar docking, customization and cool menu support.
/////////////////////////////////////////////////////////////////////////////
class _XT_EXT_CLASS CXTOleIPFrameWnd : public COleIPFrameWnd
{
...
public:
	...
	//						CXTOleIPFrameWnd::EnableDocking. The side chosen is determined by 
	//						pDockBar.
...
//---------------------------------------------------------------------------
inline CXTCoolMenu* CXTOleIPFrameWnd::GetCoolMenu()
	{ ASSERT(::IsWindow(m_hWnd)); return &m_coolMenu; }
//---------------------------------------------------------------------------
inline CXTMenuBar* CXTOleIPFrameWnd::GetMenuBar()
