...
/////////////////////////////////////////////////////////////////////////////
// CXTMDIFrameWnd extends the standard CMDIFrameWnd class to allow CXTDockWindow
// and CXTToolBar docking, customization and cool menu support.
/////////////////////////////////////////////////////////////////////////////
class _XT_EXT_CLASS CXTMDIFrameWnd : public CMDIFrameWnd
{
...
public:
	...
	//						CXTMDIFrameWnd::EnableDocking. The side chosen is determined by 
	//						pDockBar.
...
//---------------------------------------------------------------------------
inline CXTCoolMenu* CXTMDIFrameWnd::GetCoolMenu()
	{ ASSERT(::IsWindow(m_hWnd)); return &m_coolMenu; }
//---------------------------------------------------------------------------
inline CXTMenuBar* CXTMDIFrameWnd::GetMenuBar()
