...
// (DO NOT EDIT: machine generated header) 'GIFImage.pas' rev: 5.00
...
public:
	...
	/* Exception.Create */ inline __fastcall GIFException(const AnsiString Msg) : Graphics::EInvalidGraphic(
		Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall GIFException(const AnsiString Msg, const System::TVarRec 
		* Args, const int Args_Size) : Graphics::EInvalidGraphic(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall GIFException(int Ident)/* overload */ : Graphics::EInvalidGraphic(
		Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall GIFException(int Ident, const System::TVarRec * Args
		, const int Args_Size)/* overload */ : Graphics::EInvalidGraphic(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall GIFException(const AnsiString Msg, int AHelpContext) : 
		Graphics::EInvalidGraphic(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall GIFException(const AnsiString Msg, const System::TVarRec 
		* Args, const int Args_Size, int AHelpContext) : Graphics::EInvalidGraphic(Msg, Args, Args_Size, AHelpContext
		) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall GIFException(int Ident, int AHelpContext)/* overload */
		 : Graphics::EInvalidGraphic(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall GIFException(System::PResStringRec ResStringRec, 
		const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : Graphics::EInvalidGraphic(
...
public:
	...
	/*         class method */ static TGIFColor __fastcall Color2RGB(TMetaClass* vmt, Graphics::TColor 
		Color);
	/*         class method */ static Graphics::TColor __fastcall RGB2Color(TMetaClass* vmt, TGIFColor 
		Color);
...
public:
	...
	void __fastcall Clear(void);
	__property TGIFVersion Version = {read=GetVersion, nodefault};
	__property Word Width = {read=FLogicalScreenDescriptor.ScreenWidth, write=FLogicalScreenDescriptor.ScreenWidth
		, nodefault};
	__property Word Height = {read=FLogicalScreenDescriptor.ScreenHeight, write=FLogicalScreenDescriptor.ScreenHeight
		, nodefault};
	__property Byte BackgroundColorIndex = {read=FLogicalScreenDescriptor.BackgroundColorIndex, write=SetBackgroundColorIndex
		, nodefault};
	__property Graphics::TColor BackgroundColor = {read=GetBackgroundColor, write=SetBackgroundColor, nodefault
		};
	__property Byte AspectRatio = {read=FLogicalScreenDescriptor.AspectRatio, write=FLogicalScreenDescriptor.AspectRatio
		, nodefault};
...
#pragma option push -b-
enum TGIFDrawOption { goAsync, goTransparent, goAnimate, goLoop, goLoopContinously, goValidateCanvas, 
	goDirectDraw, goClearOnLoop, goTile, goDither, goAutoDither };
#pragma option pop

typedef Set<TGIFDrawOption, goAsync, goAutoDither>  TGIFDrawOptions;

#pragma option push -b-
enum TColorReduction { rmNone, rmWindows20, rmWindows256, rmWindowsGray, rmMonochrome, rmGrayScale, 
...
typedef void __fastcall (__closure *TGIFWarning)(System::TObject* Sender, TGIFSeverity Severity, AnsiString 
	Message);
...
public:
	__fastcall TGIFPainter(TGIFImage* AImage, Graphics::TCanvas* ACanvas, const Windows::TRect &ARect, 
		TGIFDrawOptions Options);
	__fastcall TGIFPainter(PGIFPainter Painter, TGIFImage* AImage, Graphics::TCanvas* ACanvas, const Windows::TRect 
		&ARect, TGIFDrawOptions Options);
	...
	__property Windows::TRect Rect = {read=FRect, write=FRect};
...
protected:
	...
	TGIFPainter* __fastcall InternalPaint(PGIFPainter Painter, Graphics::TCanvas* ACanvas, const Windows::TRect 
		&Rect, TGIFDrawOptions Options);
...
public:
	...
	void __fastcall Optimize(TGIFOptimizeOptions Options, TColorReduction ColorReduction, TDitherMode DitherMode
		, int ReductionBits);
	void __fastcall Clear(void);
	void __fastcall StopDraw(void);
	TGIFPainter* __fastcall Paint(Graphics::TCanvas* ACanvas, const Windows::TRect &Rect, TGIFDrawOptions 
		Options);
	...
	__property int ColorResolution = {read=GetColorResolution, nodefault};
	__property int BitsPerPixel = {read=GetBitsPerPixel, nodefault};
	__property Byte BackgroundColorIndex = {read=GetBackgroundColorIndex, write=SetBackgroundColorIndex
		, nodefault};
	__property Graphics::TColor BackgroundColor = {read=GetBackgroundColor, write=SetBackgroundColor, nodefault
		};
	...
	__property Graphics::TColor DrawBackgroundColor = {read=FDrawBackgroundColor, write=FDrawBackgroundColor
		, nodefault};
...
protected:
	...
	/*         class method */ static void __fastcall RegisterExtension(TMetaClass* vmt, Byte elabel, TMetaClass* 
		eClass);
	/*         class method */ static TMetaClass* __fastcall FindExtension(TMetaClass* vmt, Classes::TStream* 
		Stream);
	#pragma option push -w-inl
	/* virtual class method */ virtual TMetaClass* __fastcall FindSubExtension(Classes::TStream* Stream
		) { return FindSubExtension(__classid(TGIFExtension), Stream); }
	#pragma option pop
	/*         class method */ static TMetaClass* __fastcall FindSubExtension(TMetaClass* vmt, Classes::TStream* 
		Stream);
...
public:
	...
	__property Byte TransparentColorIndex = {read=GetTransparentColorIndex, write=SetTransparentColorIndex
		, nodefault};
...
protected:
	...
	Windows::TRect __fastcall GetClientRect();
	...
	Windows::TRect __fastcall ScaleRect(const Windows::TRect &DestRect);
...
public:
	...
	virtual void __fastcall LoadFromStream(Classes::TStream* Stream);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	void __fastcall Draw(Graphics::TCanvas* ACanvas, const Windows::TRect &Rect, bool DoTransparent, bool 
		DoTile);
	void __fastcall StretchDraw(Graphics::TCanvas* ACanvas, const Windows::TRect &Rect, bool DoTransparent
		, bool DoTile);
...
public:
	...
	virtual void __fastcall SaveToStream(Classes::TStream* Stream);
	virtual void __fastcall LoadFromStream(Classes::TStream* Stream);
	/*         class method */ static void __fastcall RegisterExtension(TMetaClass* vmt, const TGIFApplicationRec 
		&eIdent, TMetaClass* eClass);
	#pragma option push -w-inl
	/* virtual class method */ virtual TMetaClass* __fastcall FindSubExtension(Classes::TStream* Stream
		) { return FindSubExtension(__classid(TGIFApplicationExtension), Stream); }
	#pragma option pop
	/*         class method */ static TMetaClass* __fastcall FindSubExtension(TMetaClass* vmt, Classes::TStream* 
		Stream);
...
extern PACKAGE void __fastcall InternalGetDIBSizes(HBITMAP Bitmap, int &InfoHeaderSize, int &ImageSize
	, Graphics::TPixelFormat PixelFormat);
extern PACKAGE bool __fastcall InternalGetDIB(HBITMAP Bitmap, HPALETTE Palette, void *BitmapInfo, void 
	*Bits, Graphics::TPixelFormat PixelFormat);
extern PACKAGE HPALETTE __fastcall CreateOptimizedPaletteFromManyBitmaps(Classes::TList* Bitmaps, int 
	Colors, int ColorBits, bool Windows);
extern PACKAGE Graphics::TBitmap* __fastcall ReduceColors(Graphics::TBitmap* Bitmap, TColorReduction 
	ColorReduction, TDitherMode DitherMode, int ReductionBits, HPALETTE CustomPalette);
