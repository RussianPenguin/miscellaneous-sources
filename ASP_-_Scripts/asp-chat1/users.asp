...
<font face="Trebuchet MS, ms sans serif, Verdana,Arial" size=2 color=#476895><b>Who's Online</b></font>
</td></tr></table>
<br>
   ...
   If Not IsEmpty(Application.Contents("Users")) Then
         ...
         For I = 0 To NumOfUsers
               If Topic = Group(I) Then
		   			...
		   			Response.Write "&nbsp;<b>In:</b> " & Application("UsersTimeOn")(I) & "</small><br><br>"
               End If
         Next
   End If
...
<br><br><br>
<font face="ms sans serif" size=1 color=#476895><b>Click name to send private message </b></font>
