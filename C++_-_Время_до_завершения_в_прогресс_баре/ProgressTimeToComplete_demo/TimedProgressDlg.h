...
// Dialog Data
	...
	TProgressTimeToComplete	m_progress4;
	TProgressTimeToComplete	m_progress3;
	TProgressTimeToComplete	m_progress2;
	TProgressTimeToComplete	m_progress1;
	//}}AFX_DATA
...
protected:
	...
	afx_msg void OnSpeedReleasedCapture(NMHDR* pNMHDR, LRESULT* pResult);
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
